  ...
  <vs-sidebar click-not-close position-right parent="body" default-index="1" color="primary" class="add-new-data-sidebar items-no-padding" spacer v-model="isSidebarActiveLocal">
    ...
    <VuePerfectScrollbar class="scroll-area--data-list-add-new" :settings="settings">
      ...
      <div class="p-6">
        ...
        <!-- NGÀY SINH -->
        <vs-input label="Ngày sinh" type="date" v-model="user.birth_day" class="mt-5 v-col-6" name="birth_day" />

        <!-- GIỚI TÍNH -->
       <vs-select v-model="dataOrder_status" label="Order Status" class="mt-5 vs-col-6">
          <vs-select-item :key="item.value" :value="item.gt_user" :text="item.text" v-for="item in gender" />
        </vs-select>
