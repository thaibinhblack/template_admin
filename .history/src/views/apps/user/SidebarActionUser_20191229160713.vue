      ...
      <div class="p-6">
        ...
        <vs-row vs-w="12">
          ...
          <vs-col vs-type="flex" vs-justify="center" vs-align="center" vs-lg="6" vs-sm="6" vs-xs="12">
            <vs-select v-model="user.gt_user" label="Giới tính" class="mt-5 w-full">
        ...
        <!-- ĐỊA CHỈ USER -->
        <vs-textarea class="mt-5 w-full"  counter="255" label="Địa chỉ" :counter-danger.sync="counterDanger" v-model="user.dc_user" />
