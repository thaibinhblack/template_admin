  ...
  <vs-sidebar click-not-close position-right parent="body" default-index="1" color="primary" class="add-new-data-sidebar items-no-padding" spacer v-model="isSidebarActiveLocal">
    ...
    <VuePerfectScrollbar class="scroll-area--data-list-add-new" :settings="settings">
      ...
      <div class="p-6">
        ...
        <span class="text-danger text-sm" v-show="errors.has('username_user')">{{ errors.first('username_user') }}</span>
        ...
        <span class="text-danger text-sm" v-show="errors.has('password_user')">{{ errors.first('password_user') }}</span>

         <!-- HỌ & TÊN -->
        <vs-input label="Họ & Tên" type="password" v-model="user.ho_ten_user" class="mt-5 w-full" name="ho_ten_user" v-validate="'required'" />
