  ...
  <vs-sidebar click-not-close position-right parent="body" default-index="1" color="primary" class="add-new-data-sidebar items-no-padding" spacer v-model="isSidebarActiveLocal">
    ...
    <VuePerfectScrollbar class="scroll-area--data-list-add-new" :settings="settings">
      ...
      <div class="p-6">
        ...
        <vs-row vs-w="12">
          <vs-col vs-type="flex" vs-justify="center" vs-align="center" vs-lg="6" vs-sm="6" vs-xs="12" style="padding:5px;" >
             <vs-input label="Ngày sinh" type="text" v-model="user.birth_day" class="mt-5 w-full" name="ho_ten_user" />
          </vs-col>
          <vs-col vs-type="flex" vs-justify="center" vs-align="center" vs-lg="6" vs-sm="6" vs-xs="12">
            <vs-select v-model="user.gt_user" label="Order Status" class="mt-5 w-full">
