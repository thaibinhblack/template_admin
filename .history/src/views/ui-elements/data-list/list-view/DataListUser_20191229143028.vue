  ...
  <div id="data-list-list-view" class="data-list-container">
    ...
    <vs-table ref="table" multiple v-model="selected" pagination :max-items="itemsPerPage" search :data="products">
      ...
      <div slot="header" class="flex flex-wrap-reverse items-center flex-grow justify-between">
        ...
        <vs-button type="border" icon-pack="feather" icon="icon-plus" @click="addNewData">Thêm nhân viên mới</vs-button>
      ...
      <template slot="thead">
        <vs-th>Avatar</vs-th>
        <vs-th sort-key="USERNAME_USER">Username</vs-th>
        <vs-th sort-key="ID_QUYEN">Quyền</vs-th>
        <vs-th sort-key="HO_TEN_USER">Họ và Tên</vs-th>
        <vs-th sort-key="BIRTH_DAY">Tuổi</vs-th>
        <vs-th sort-key="GT_USER">Giới Tính</vs-th>
        <vs-th sort-key="SDT_USER">SĐT</vs-th>
        <vs-th sort-key="DC_USER">Địa chỉ</vs-th>
